...
\textsc{Present}& {- I am working on a Blockchain based Content Delivery Network (CDN). This will enable web hosting companies to utilise their comatose resources to generate revenue}\\
& {- I am also investigating Blockchain perspectives and challenges and implementing distributed content delivery, load balancing, DDoS mitigation, smart contracts development}\\
...
\textsc{Dec 18}& {- A bash script which sets/unsets proxy for most frequently used commands in Debian/Ubuntu}\\
...
\item \textbf{Admin, \href{https://www.biryanify.com}{Biryanify}}: Hosted an e-commerce website for our family-run business on Shopify. Customized the website along with content writing and graphics design for digital marketing on \href{https://www.facebook.com/biryanify}{Facebook} and \href{https://www.instagram.com/biryanify/}{Instagram}.
